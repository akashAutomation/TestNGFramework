...
public class DependsOnMethodsDemo {
	 ...
	 *    ex-> We have to put dependsOnMethods = "login" in homePage() and registratioPage() so it means that these methods are depending on
	 ...
	 *    "org.testng.TestNGException: com.Demo.DependsOnMethodsDemo.RegistrationPage() depends on nonexistent method Home"
	 *    
	 * 4. Order of running the test cases depend on its dependent methods.
	 */
